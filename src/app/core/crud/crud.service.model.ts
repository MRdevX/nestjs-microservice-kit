import { DeepPartial, DeleteResult, FindOptionsWhere, FindOneOptions, UpdateResult } from 'typeorm';
...
export interface ICrudService<T> {
  ...
  findOne(id: string | number | FindOneOptions<T> | FindOptionsWhere<T>, options?: FindOneOptions<T>): Promise<T>;
